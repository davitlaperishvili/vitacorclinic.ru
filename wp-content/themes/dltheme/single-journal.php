            ...
            <div class="post_data">
              ...
              <div class="data_right">
                <?php 
                  if($time_to_read){
                    ?>
                      <div class="time_to_read"><span>Время чтения: </span><?php echo $time_to_read ?></div>
                    <?php
                  }
                ?>
                <div class="date">
            ...
            if( have_rows('journal') ):
              ...
              while ( have_rows('journal') ) : the_row();
                  ...
                  if( get_row_layout() == 'text_block' ):
                      include(TEMPLATEPATH.'/acf-widgets/journal/widget-text_block.php');
                  
                  elseif( get_row_layout() == 'table_of_content' ):
                      include(TEMPLATEPATH.'/acf-widgets/journal/widget-table_of_content.php');
                  elseif( get_row_layout() == 'journal_promo' ):
                      include(TEMPLATEPATH.'/acf-widgets/journal/widget-journal_promo.php');
                  elseif( get_row_layout() == 'place_for_contact_form_on_mobile' ):
                      include(TEMPLATEPATH.'/acf-widgets/journal/widget-place_for_contact_form_on_mobile.php');
