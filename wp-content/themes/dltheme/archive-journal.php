...
<main class="blog_page dl_page">
  ...
  <section class="journal_taxonomy">
    <div class="container">
      ...
      <div class="category_list">
        <ul>
          <li class="is-active"><a href="/journal/">Все</a></li>
          <?php 
  ...
  <section class="blog_page">
    <div class="container">
      <div class="content">
        <section class="blog_posts_listing">
          <?php
          $args = array(
              'post_type' => 'journal',
              'posts_per_page' => 9,
          ...
          if ($query->max_num_pages > 1){
            ?>
              <div class="theme_button load_more">
                <button id="load-more" data-maxpage="<?php echo $post_type_data->max_num_pages ?>" >Показать еще</button>
              </div>
            <?php
          }
        ?>
